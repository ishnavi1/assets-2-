							...
							<form>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-3">
								  ...
								  <input disabled type="text" class="form-control" value="0" name="itemDetailsDiscount" id="itemDetailsDiscount">
								</div>
								<div class="form-group col-md-3">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#invoiceReportsTab">Invoice</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						...
						<div id="invoiceReportsTab" class="container-fluid tab-pane fade">
							<br>
							<form name="form" target="_blank" action="viewInvoice.php" method="get"> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									<label for="saleReportStartDate">Challan Number</label>
									<input type="text" class="form-control" id="saleIdInput" value="" name="saleIdInput">
								  </div>

								  

							  </div>
							  <!-- <button type="button" id="showSaleReport" class="btn btn-dark" onclick="window.location.href = 'Invoice123.html';">Show Invoice</button> -->
							  <button type="submit" id="showSaleReport" class="btn btn-dark">Show Invoice</button>
							  <button type="reset" id="saleFilterClear" class="btn">Clear</button>
							</form>
							<br><br>
							<div class="table-responsive" id="invoiceReportsTableDiv"></div>
						</div>
